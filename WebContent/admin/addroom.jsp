...
%><body>
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr valign="top">
			<td bgcolor="#FFFFFF"><form action="room/addRoom.action"
					...
					<table width="40%" border="0" align="center" cellpadding="4"
						...
						<tr align="center" bgcolor="#F2FDFF">
							<td align="left" colspan="2" class="optiontitle">添加教室</td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
							<td width="20%" align="right">教室名称</td>
							<td align="left"><input type="text" placeholder="请输入教室名称"
								name="room_name" style="width: 160px" id="room_name" /></td>
								
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
								<td width="20%" align="down">地址名称</td>
							<td align="left"><input type="text" placeholder="请输入地址名称"
								name="room_adress" style="width: 160px" id="room_adress" /></td>
						</tr>
