		...
		<tr valign="top">
			<td bgcolor="#FFFFFF"><table width="96%" border="0"
					...
					<tr align="left" bgcolor="#F2FDFF">
						<td colspan="20" class="optiontitle">课程视频信息列表</td>
					</tr>
					<tr align="center">
					...
					<c:forEach items="${vedioList}" var="vedio">
						<tr align="center" bgcolor="#FFFFFF">
							<td align="center">${vedio.title}</td>
							<td align="center">${vedio.coursename}</td>
							<td align="center">${vedio.addtime}</td>
							<td align="center">${vedio.hits}</td>
							<td align="center"><a
								href="vedio/getVedioById.action?id=${vedio.vedioid}">编辑</a>|<a
								href="vedio/deleteVedio.action?id=${vedio.vedioid}"
