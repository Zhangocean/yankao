	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr valign="top">
			<td bgcolor="#FFFFFF"><form
					action="teacher/updateTeacher.action" name="myform" method="post"
					onsubmit="return check()">
					<table width="80%" border="0" align="center" cellpadding="4"
						cellspacing="1" bgcolor="#aec3de">
						<tr align="center" bgcolor="#F2FDFF">
							<td align="left" colspan="2" class="optiontitle">修改教师<input
								type="hidden" name="teacherid" value="${teacher.teacherid}" /></td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
							<td width="20%" align="right">教师姓名</td>
							<td align="left"><input type="text" name="teachername"
								style="width: 160px" id="teachername"
								value="${teacher.teachername}" /></td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
							<td width="20%" align="right">照片</td>
							<td align="left"><input type="text" name="image"
								style="width: 160px" id="image" value="${teacher.image}"
						...
						<tr align="center" bgcolor="#F2FDFF">
							...
							<td align="left"><input type="text" name="birthday"
								style="width: 160px" id="birthday" value="${teacher.birthday}"
						...
						<tr align="center" bgcolor="#F2FDFF">
							...
							<td align="left"><script type="text/javascript"
								...
								<textarea cols="80" name="contents" id="contents" rows="10">${teacher.contents}</textarea>
								<script type="text/javascript">
