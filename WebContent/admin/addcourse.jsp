...
%><body>
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr valign="top">
			<td bgcolor="#FFFFFF"><form action="course/addCourse.action"
					...
					<table width="80%" border="0" align="center" cellpadding="4"
						...
						<tr align="center" bgcolor="#F2FDFF">
							<td align="left" colspan="2" class="optiontitle">添加课程</td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
							<td width="20%" align="right">课程名称</td>
							<td align="left"><input type="text" placeholder="请输入课程名称"
								name="coursename" style="width: 160px" id="coursename" /></td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
