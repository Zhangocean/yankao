		...
		<tr valign="top">
			<td bgcolor="#FFFFFF"><table width="96%" border="0"
					...
					<tr align="left" bgcolor="#F2FDFF">
						<td colspan="20" class="optiontitle">教师信息列表</td>
					</tr>
					<tr align="center">
						<td align="center" bgcolor="#ebf0f7">教师姓名</td>
					...
					<c:forEach items="${teacherList}" var="teacher">
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td align="center">${teacher.sex}</td>
							<td align="center">${teacher.birthday}</td>
						</tr>
					</c:forEach>
					<tr align="right" bgcolor="#ebf0f7">
						<td colspan="20"><form
								action="teacher/queryTeacherByCond.action" name="myform"
								method="post">
								查询条件<select name="cond" style="width: 100px"><option
										value="teachername">按教师姓名查询</option>
									<option value="sex">按性别查询</option>
									<option value="birthday">按出生日期查询</option></select>关键字<input type="text"
