		...
		<tr valign="top">
			<td bgcolor="#FFFFFF"><table width="96%" border="0"
					...
					<tr align="left" bgcolor="#F2FDFF">
						<td colspan="20" class="optiontitle">上课地址信息列表</td>
					</tr>
					<tr align="center">
						<td align="center" bgcolor="#ebf0f7">教室名称</td>
						<td align="center" bgcolor="#ebf0f7">地址名称</td>
						<td align="center" bgcolor="#ebf0f7" width="10%">操作</td>
					</tr>
					<c:forEach items="${roomList}" var="room">
						<tr align="center" bgcolor="#FFFFFF">
							<td align="center">${room.room_name}</td>
							<td align="center">${room.room_adress}</td>
							<td align="center"><a
								href="room/getRoomById.action?id=${room.room_id}">编辑</a>|<a
								href="room/deleteRoom.action?id=${room.room_id}"
