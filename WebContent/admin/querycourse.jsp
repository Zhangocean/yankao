		...
		<tr valign="top">
			<td bgcolor="#FFFFFF"><table width="96%" border="0"
					...
					<tr align="left" bgcolor="#F2FDFF">
						<td colspan="20" class="optiontitle">课程信息列表</td>
					</tr>
					<tr align="center">
						<td align="center" bgcolor="#ebf0f7">课程名称</td>
						<td align="center" bgcolor="#ebf0f7">课程类型</td>
						<td align="center" bgcolor="#ebf0f7">教师</td>
					...
					<c:forEach items="${courseList}" var="course">
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td align="center">${course.cateid}</td>
							<td align="center">${course.teacherid}</td>
							<td align="center">${course.addtime}</td>
							<td align="center">${course.hits}</td>
						</tr>
					</c:forEach>
					<tr align="right" bgcolor="#ebf0f7">
						<td colspan="20"><form
								action="course/queryCourseByCond.action" name="myform"
								method="post">
								查询条件<select name="cond" style="width: 100px"><option
										value="coursename">按课程名称查询</option>
