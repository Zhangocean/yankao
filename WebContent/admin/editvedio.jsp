...
%><body>
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr valign="top">
			<td bgcolor="#FFFFFF"><form action="vedio/updateVedio.action"
					...
					<table width="40%" border="0" align="center" cellpadding="4"
						...
						<tr align="center" bgcolor="#F2FDFF">
							<td align="left" colspan="2" class="optiontitle">修改课程视频<input
								type="hidden" name="vedioid" value="${vedio.vedioid}" /></td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
							<td width="20%" align="right">标题</td>
							<td align="left"><input type="text" name="title"
								style="width: 160px" id="title" value="${vedio.title}" /></td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
						...
						<tr align="center" bgcolor="#F2FDFF">
							...
							<td align="left">
								<textarea name="url" id="url" style="width: 99%;height:120px;">${vedio.url}</textarea>
								</td>
						</tr>
						<input type="hidden" name="addtime" id="addtime"
							value="${vedio.addtime}" />
						<input type="hidden" name="hits" id="hits" value="${vedio.hits}" />
